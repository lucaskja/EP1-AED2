...
int kosarayu1(Grafo* G, Vertice** vertices, int* visitados, int* cfc, int* d, int* f){
    // Fase 1 começa aqui
    Grafo* GT = transposta(G, vertices);
    tempod = tempof = 0;
    int v; 
...
int kosarayu2(Grafo* G, Vertice** vertices, int* visitados, int* cfc, int* d, int* f){
   // Fase 1
   tempod = tempof = 0;
   int v;
